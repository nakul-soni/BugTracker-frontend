          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="text-zinc-400 text-lg font-normal leading-relaxed max-w-md">
                Join thousands of engineering teams who use BugTracker to deliver high-quality software at scale.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 pt-4 border-t border-zinc-800/50">
              <div>
                ...
                <p className="text-sm text-zinc-500 leading-relaxed">Streamline your workflow from issue to resolution.</p>
              </div>
              <div>
                <div className="text-white font-semibold mb-1 flex items-center gap-2">
                ...
                <p className="text-sm text-zinc-500 leading-relaxed">Complete oversight of your project's health.</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="max-w-[360px] mx-auto w-full space-y-8">
            ...
            <div className="space-y-2">
              <h2 className="text-zinc-900 text-3xl font-bold tracking-tight">Create an account</h2>
              <p className="text-zinc-500 text-sm">Join BugTracker today and start squashing bugs.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button 
                type="submit" 
                disabled={loading} 
                className="w-full h-11 bg-black hover:bg-zinc-800 text-white rounded-lg text-sm font-semibold group transition-all mt-2"
              >
            ...
            <p className="text-center text-sm text-zinc-500">
              ...
              <Link href="/login" className="ml-1.5 text-black font-semibold hover:underline underline-offset-4">Log in</Link>
            </p>
          </div>
        </motion.div>
      </div>
